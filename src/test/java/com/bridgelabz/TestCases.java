...
public class TestCases {
    ...
    public void whenGiven10KmAnd4MinutesAndFareAs109_shouldReturnEqual() {
        ...
        Assert.assertEquals(fare.getTotalFare(), 104, 0.5);
    }

    @Test
    public void whenGivenFareIsLessThanMinFare_shouldReturnEqual() {
        Fare fare = new Fare(0, 0);
        Assert.assertEquals(fare.getFare(), 5, 0.1);
    }

    @Test
    public void whenGivenMultipleRides_ifRequiredFarePerRide_shouldReturnEqual() {
        Fare fare = new Fare(2, 0);
        Assert.assertEquals(fare.getFare(), 20, 0.5);
        fare.bookCab(4, 2);
        Assert.assertEquals(fare.getFare(), 42, 0.5);
    }
    ...
    public void whenGivenMultipleRides_ifAdded_shouldReturnEqual() {
        ...
        fare.bookCab(10, 8);
        Assert.assertEquals(fare.getTotalFare(), 150, 0.5);
    }
    ...
    public void whenGivenMultipleRides_ifRequiredAverageFare_shouldReturnEqual() {
        ...
        fare.bookCab(4, 2);
        fare.bookCab(6, 1);
        Assert.assertEquals(fare.averageFare(), 52, 0.5);
    }

    @Test
    public void whenGivenPremiumRide_shouldReturnEqual() {
        Fare fare = new Fare(5, 4, true);
        Assert.assertEquals(fare.getFare(), 83, 0.1);
    }
